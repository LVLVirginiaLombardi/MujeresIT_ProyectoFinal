...
/* Creamos una sentencia de REVOKE para ambos users así no podrán eliminar en ningún caso ningún dato de la BBDD MujeresIT.
Esto es simplemente para asegurarnos de que no puedan eliminar nada. */
